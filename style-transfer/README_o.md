...
`python run_train.py --style style/wave.jpg --output model --trainDB ../../dataset/train2014 --vgg_model ../../ --checkpoint_every 100 --test content/female_knight.jpg --batch_size 1`
